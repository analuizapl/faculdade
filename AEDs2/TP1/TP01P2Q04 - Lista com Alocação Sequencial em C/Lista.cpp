...
int ops;
              ...
              for(int i = 0; i < ops; i++){
                  scanf("%s ", diretorio);
                  if(!(strcmp(diretorio,"IF"))){
                      scanf("%s", diretorio);
                      Time * time = read(diretorio);
                      inserirFim(time);
                      time = NULL;
                  }
                  else if(!(strcmp(diretorio,"II"))){
                      scanf("%s", diretorio);
                      Time * time = read(diretorio);
                      inserirInicio(time);
                      time = NULL;
                  }
                  else if(!(strcmp(diretorio,"I*"))){
                      scanf("%d", &posicao);
                      scanf("%s", diretorio);
                      Time * time = read(diretorio);
                      inserir(time, posicao);
                      time = NULL;
                  }
                  else if(!(strcmp(diretorio,"RI"))){
                      Time * time = removerInicio();
                      printf("(R) %s\n", time->nome);
                      time = NULL;
                  }
                  else if(!(strcmp(diretorio,"RF"))){
                      Time * time = removerFim();
                      printf("(R) %s\n", time->nome);
                      time = NULL;
                  }
                  else if(!(strcmp(diretorio,"R*"))){
                      scanf("%d", &posicao);
                      Time * time = remover(posicao);
                      printf("(R) %s\n", time->nome);
                      time = NULL;
                  }
              }

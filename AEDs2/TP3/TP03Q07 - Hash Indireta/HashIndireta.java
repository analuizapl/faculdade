...
import java.util.Scanner;
 ...
 class Hash {
   ...
   public Hash (int tamTab){
      this.tamTab = tamTab;
      this.tabela = new Time [this.tamTab];
      for(int i = 0; i < tamTab ; i++){
         tabela[i] = null;
      }
   }

   public int h(Time elemento){
      return (int)elemento.getPaginaTam() % tamTab;
   }

   public int reh(Time elemento){
      return (int)((elemento.getPaginaTam()+1))%tamTab;
   }
